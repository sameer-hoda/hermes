...
```
curl -sSL https://raw.githubusercontent.com/your-username/wa-pull/main/install.sh | bash
```
...
```bash
git clone https://github.com/your-username/wa-slash-commands
...
```bash
# Clone
git clone https://github.com/your-username/wa-pull && cd wa-pull
