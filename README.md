...
# Requires Go 1.21+ for the bridge (installed automatically on first run)
...
| **Personal assistant** | Talk naturally in your self-chat. Conversation continuity, intent routing |
